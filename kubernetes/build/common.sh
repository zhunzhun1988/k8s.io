  ...
  case $1 in
    ...
    "arm")
        local targets=(
          ...
          kube-rescheduler,arm32v7/busybox
    ...
    "arm64")
        local targets=(
          ...
          kube-rescheduler,arm64v8/busybox
    ...
    "ppc64le")
        local targets=(
          ...
          kube-rescheduler,ppc64le/busybox
    ...
    "s390x")
        local targets=(
          ...
          kube-rescheduler,s390x/busybox
