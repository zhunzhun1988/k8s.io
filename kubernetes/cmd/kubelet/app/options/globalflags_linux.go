...
func addCadvisorFlags(fs *pflag.FlagSet) {
	...
	registerDeprecated(global, local, "storage_driver", deprecated)
	registerDeprecated(global, local, "storage_duration", deprecated)
	registerDeprecated(global, local, "storage_driver_kafka_broker_list", deprecated)
	registerDeprecated(global, local, "storage_driver_kafka_topic", deprecated)
	registerDeprecated(global, local, "storage_driver_kafka_ssl_cert", deprecated)
	registerDeprecated(global, local, "storage_driver_kafka_ssl_key", deprecated)
	registerDeprecated(global, local, "storage_driver_kafka_ssl_ca", deprecated)
	registerDeprecated(global, local, "storage_driver_kafka_ssl_verify", deprecated)
