...
type KubeControllerManagerOptions struct {
	...
	FPSController                    *cmoptions.FPSControllerOptions
...
func NewKubeControllerManagerOptions() (*KubeControllerManagerOptions, error) {
	...
	s := KubeControllerManagerOptions{
		...
		FPSController: &cmoptions.FPSControllerOptions{
			FailPodScaleLimit: componentConfig.FPSController.FailPodScaleLimit,
		},
...
func (s *KubeControllerManagerOptions) ApplyTo(c *kubecontrollerconfig.Config, userAgent string) error {
	...
	if err := s.FPSController.ApplyTo(&c.ComponentConfig.FPSController); err != nil {
		return err
	}
...
func (s *KubeControllerManagerOptions) Validate(allControllers []string, disabledByDefaultControllers []string) error {
	...
	errs = append(errs, s.FPSController.Validate()...)
