...
type DeprecatedOptions struct {
	...
	BaseAuthCVSFile, ServerAddr, ServerCertPath, ServerKeyPath string
}
...
func (o *DeprecatedOptions) AddFlags(fs *pflag.FlagSet, cfg *componentconfig.KubeSchedulerConfiguration) {
	...
	fs.StringVar(&cfg.ServerCertPath, "config-policy-servercertpath", "", "config web interface https server cert. host:port/config/get or host:port/config/set")
	fs.StringVar(&cfg.ServerKeyPath, "config-policy-serverkeypath", "", "config web interface https server private key. host:port/config/get or host:port/config/set")
	fs.StringVar(&cfg.BaseAuthCVSFile, "config-policy-baseauthfile", "", "config web interface https server base auth. host:port/config/get or host:port/config/set")
	fs.StringVar(&cfg.ServerAddr, "config-policy-serveraddr", "", "config web interface https server addr. host:port/config/get or host:port/config/set")
