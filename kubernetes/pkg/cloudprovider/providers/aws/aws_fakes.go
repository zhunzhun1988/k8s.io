...
func (self *FakeELBV2) DescribeTags(input *elbv2.DescribeTagsInput) (*elbv2.DescribeTagsOutput, error) {
	panic("Not implemented")
}

func (self *FakeELBV2) RemoveTags(input *elbv2.RemoveTagsInput) (*elbv2.RemoveTagsOutput, error) {
	panic("Not implemented")
}
