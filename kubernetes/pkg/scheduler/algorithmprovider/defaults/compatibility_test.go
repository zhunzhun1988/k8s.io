    ...
    {"name": "TestLabelPreference",      "weight": 4, "argument": {"labelPreference": {"label": "bar", "presence":true}}}
		...
		"1.11": {
		  ...
		  "predicates": [
			...
			{"name": "GeneralPredicates"},
			{"name": "CheckVolumeBinding"},
            {"name": "NodeNameSpacePredicate"},
			{"name": "PodHostPathPVDiskPressure"},
			{"name": "HostPathPVAffinityPredicate"},
			{"name": "HostPathPVAffinityPredicate2"},
			{"name": "NamespacesNodeSelector"},
			{"name": "TestServiceAffinity", "argument": {"serviceAffinity" : {"labels" : ["region"]}}},
			{"name": "TestLabelsPresence",  "argument": {"labelsPresence"  : {"labels" : ["foo"], "presence":true}}}
		  ],"priorities": [
			{"name": "EqualPriority",   "weight": 2},
			...
			{"name": "InterPodAffinityPriority",   "weight": 2},
			{"name": "MostRequestedPriority",   "weight": 2},
            {"name": "NodeNameSpacePriority", "weight":2},
			{"name": "NodePVDiskUsePriority", "weight": 2},
			{"name": "PVNodeSpreadPriority", "weight": 2},
			{
