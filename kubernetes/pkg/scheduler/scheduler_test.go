...
func (es mockScheduler) GetPredicates() map[string]algorithm.FitPredicate {
	return nil
}
func (es mockScheduler) AddPredicate(predicatName string) (bool, error) {
	return false, nil
}
func (es mockScheduler) RemovePredicate(predicatName string) (bool, error) {
	return false, nil
}
func (es mockScheduler) GetPrioritys() []algorithm.PriorityConfig {
	return nil
}
func (es mockScheduler) AddPriority(priorityName string) (bool, error) {
	return false, nil
}
func (es mockScheduler) RemovePriority(priorityName string) (bool, error) {
	return false, nil
}
